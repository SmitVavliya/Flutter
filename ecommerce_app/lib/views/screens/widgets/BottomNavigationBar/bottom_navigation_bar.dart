...
import "package:ecommerce_app/views/screens/widgets/BottomNavigationBar/bottom_curved_Painter.dart";
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
                color: isEnable ? ePrimaryColor : Colors.white,
                boxShadow: <BoxShadow>[
                  BoxShadow(
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.rss_feed, _selectedIndex == 1, 1),
                _icon(Icons.search, _selectedIndex == 2, 2),
                _icon(Icons.shopping_bag, _selectedIndex == 3, 3),
                _icon(Icons.upload, _selectedIndex == 4, 4),
                _icon(Icons.person, _selectedIndex == 5, 5),
              ],
            ),
          ),
        ],
